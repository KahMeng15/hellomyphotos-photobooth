...
content = content.replace(
    ...
    '<AppTopNav mode="event" :event="event" currentTitle="Frames" @toggle-panel="showPanel = !showPanel" />'
)
...
"""
content = content.replace("await photosStore.fetchFrames()", "await photosStore.fetchFrames()\n" + mount_add)
